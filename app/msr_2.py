...
file1 = program_msr + 'profile' + month_msr + year_msr + '.csv' #profile file
file2 = program_msr + 'services' + month_msr + year_msr + '.csv' #services file
begindate = year_msr + month_msr + '01' #Begin Date of report (YYMMDD)
enddate = year_msr + month_msr + last_day_month[month_msr] #End Date of report (YYMMDD)
if program_msr == 'crt':
	primary_prog = '1'
else:
	primary_prog = '2'
	#If CRT, enter 1. If FFS, enter 2
# -----------------------------------------------------------------------------
...
pre_test_list = "%s_ID_list.txt" % prime_program
pre_double_check = "double_check_%s_%s.txt" % (prime_program,begindate[:4])
...
test_list = open(pre_test_list, 'w')
double_check = open(pre_double_check, 'w')
